...
<table width="100%"  border="1" cellpadding=0 cellspacing=1 bordercolorlight=#848284 bordercolordark=#eeeeee class="TABLE_STYLE1">
  ...
  <tr>
    ...
    <td class="TD_STYLE2"><input type="text" name="second_kind_id" value="" class="INPUT_STYLE1"></td>
  </tr>
  <tr>
    <td class="TD_STYLE1">II级名称</td>
    <td class="TD_STYLE2"><input type="text" name="second_kind_name" value="" class="INPUT_STYLE1"></td>
  </tr>
</table>
</form>
</body>
