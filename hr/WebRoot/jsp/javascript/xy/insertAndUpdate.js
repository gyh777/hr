...
function outFocus(){
	...
	$.each(date,function(index,item){
								...
								$('#humanFile').append("<tr>"
									...
									+"</td>"
									+"<td width='14%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].bounsSum'/>"
									+"</td>"
									+"<td width='14%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].saleSum'/>"
									+"</td>"
									+"<td width='14%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].deductSum'/>"
									+"</td>"
									+"<td width='14%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].salaryStandardSum'/>"
									+"</td>"
									+"<td width='15%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].salaryPaidSum'/>"
									+"</td>"
										+"</tr>"
								);
