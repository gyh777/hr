...
function outFocus(){
	...
	$.each(date,function(index,item){
								...
								$('#humanFile').append("<tr>"
									...
									+"</td>"
									+"<td width='14%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].bounsSum' id='mybounsSum"+index+"' onblur='myout("+index+")' value='0'/>"
									+"</td>"
									+"<td width='14%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].saleSum' id='mysaleSum"+index+"' onblur='myout("+index+")' value='"+$('#salaryStandardSum').val()+"'/>"
									+"</td>"
									+"<td width='14%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].deductSum' id='mydeductSum"+index+"' onblur='myout("+index+")' value='0'/>"
									+"</td>"
									+"<td width='14%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].salaryStandardSum' id='mysalaryStandardSum"+index+"' onblur='myout("+index+")' value='0'/>"
									+"</td>"
									+"<td width='15%' class='TD_STYLE1'>"
										+"<input type='text' class='INPUT_STYLE2' name='salaryGrantDetails["+index+"].salaryPaidSum' id='mysalaryPaidSum"+index+"' onblur='myout("+index+")' value='0'/>"
									+"</td>"
										+"</tr>"
								);
